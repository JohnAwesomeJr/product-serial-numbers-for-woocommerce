 ...
 * Admin API class.
 */
class product_serial_numbers_for_woocommerce_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'product-serial-numbers-for-woocommerce' ) . '" data-uploader_button_text="' . __( 'Use image', 'product-serial-numbers-for-woocommerce' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'product-serial-numbers-for-woocommerce' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'product-serial-numbers-for-woocommerce' ) . '" />' . "\n";
