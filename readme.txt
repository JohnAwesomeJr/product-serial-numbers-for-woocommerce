...
Contributors: JohnChristensen
Donate link: http://www.webdevsummer.com
Tags: wordpress, plugin, template
Requires at least: 3.9
Tested up to: 4.0
Stable tag: 1.0
License: GPLv2 or later
License URI: h http://www.webdevsummer.com
...
Installing "product serial numbers for woocommerce" can be done either by searching for "product serial numbers for woocommerce" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
